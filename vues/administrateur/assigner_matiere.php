            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect active"><i class="zmdi zmdi zmdi-assignment"></i> <span> Gestion des enseignements </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="assigner_matiere.php">Assigner une matière à un professeur</a></li>
        	...
        	<div class="content">
        		<div class="container">
        			<div class="row">
        				<div class="col-xs-12">
        					<div class="card-box">
        						<h4 class="header-title m-t-0 m-b-30">Assignation d'une matière à un enseignant</h4>
        						<div class="row">
        							<div class="col-xs-12">
        								<form class="form-horizontal" role="form" method="POST" action="../../controleurs/assignation_matiere.php">
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="id_enseignant">Enseignant</label>
                                                <div class="col-sm-7">
                                                    <select name="id_enseignant" id="id_enseignant" class="form-control select2">
                                                        <?php 
                                                        $bd = new bd();
                                                        $co = $bd->connexion();
        									...
        									<div class="form-group">
                                                <label for="nom_ue" class="col-sm-4 control-label">UE à assigner</label>
                                                <div class="col-sm-7">
                                                    <select class="form-control select2" name="nom_ue" id="nom_ue">
                                                        <?php 
        									...
        									<div class="form-group">
        										<div class="col-sm-offset-4 col-sm-8">
        											<button type="submit" class="btn btn-primary waves-effect waves-light">Assigner la matière</button>
        										</div>
        									</div>
        								</form>	
        							</div>	
