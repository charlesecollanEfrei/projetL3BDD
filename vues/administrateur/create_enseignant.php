        	...
        	<div class="content">
        		<div class="container">
        			<div class="row">
        				<div class="col-xs-12">
        					<div class="card-box">
        						<h4 class="header-title m-t-0 m-b-30">Ajout d'un enseignant</h4>
        						<div class="row">
        							<div class="col-xs-12">
        								<form class="form-horizontal" role="form" method="POST" action="../../controleurs/creation_enseignant.php">
        									<div class="form-group">
        										<label class="col-sm-4 control-label" for="nom_enseignant">Nom de l'enseignant</label>
        										<div class="col-sm-7">
        											<input type="text" name="nom_enseignant" class="form-control">
        										</div>
        									</div>

        									<div class="form-group">
        										<label class="col-sm-4 control-label" for="prenom_enseignant">Prénom de l'enseignant</label>
        										<div class="col-sm-7">
        											<input type="text" name="prenom_enseignant" class="form-control">
        										</div>
        									</div>

        									<div class="form-group">
        										<div class="col-sm-offset-4 col-sm-8">
        											<button type="submit" class="btn btn-primary waves-effect waves-light">Créer l'enseignant</button>
        										</div>
        									</div>
        								</form>	
        							</div>	
