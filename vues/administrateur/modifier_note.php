...
function fetch_notes(val)
{
    $.ajax({
        type: 'post',
        url: '../../controleurs/fetch_notes.php',
        data: {
            eleve:val
        },
...
function saveDatabase(id, nom_epreuve, note)
{
	$.ajax({
		type: 'post',
		url: '../../controleurs/save_note.php',
		data: {
			matricule : id,
			epreuve : nom_epreuve,
			new_note : note
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card-box">
                                <h4 class="header-title m-t-0 m-b-30">Consulter les notes d'un élève</h4>
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form action="../../controleurs/fetch_notes.php" class="form-horizontal" role="form" method="POST">
                                            <div class="form-group">
                                                <label for="eleve" class="col-sm-4 control-label">Eleve</label>
                                                <div class="col-sm-7">
                                                    <select name="eleve" id="eleve" class="form-control select2" onchange="fetch_notes(this.value)">
                                                        <?php 
                                                        $bd = new bd();
                                                        $co = $bd->connexion();
