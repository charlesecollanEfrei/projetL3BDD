                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="ajouter_epreuve.php">Ajouter une épreuve</a></li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card-box">
                                <h4 class="header-title m-t-0 m-b-30">Ajouter une épreuve</h4>
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form action="../../controleurs/ajout_epreuve.php" class="form-horizontal" role="form" method="POST">
                                            <div class="form-group">
                                                <label for="nom_epreuve" class="col-sm-4 control-label">Nom épreuve</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="nom_epreuve">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="date_epreuve" class="col-sm-4 control-label">Date de l'épreuve</label>
                                                <div class="col-sm-7">
                                                    <input type="date" class="datepicker" name="date_epreuve">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="coefficient_epreuve" class="col-sm-4 control-label">Coefficient de l'épreuve</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="coefficient_epreuve">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="nom_matiere" class="col-sm-4 control-label">Nom de la matière</label>
                                                <div class="col-sm-7">
                                                    <select name="nom_matiere" id="nom_matiere" class="form-control select2">
                                                        <?php
                                                        $bd = new bd();
                                                        $co = $bd->connexion();
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-4 col-sm-8">
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Créer l'épreuve</button>
                                                </div>
                                            </div>
