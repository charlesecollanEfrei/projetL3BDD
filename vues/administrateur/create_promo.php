                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="create_promo.php">Ajouter une promotion</a></li>
        	...
        	<div class="content">
        		<div class="container">
        			<div class="row">
        				<div class="col-xs-12">
        					<div class="card-box">
        						<h4 class="header-title m-t-0 m-b-30">Ajout d'une promotion</h4>
        						<div class="row">
        							<div class="col-xs-12">
        								<form class="form-horizontal" role="form" method="POST" action="../../controleurs/creation_promo.php">
        									<div class="form-group">
        										<label class="col-sm-4 control-label" for="annee_promo">Année de la promotion</label>
        										<div class="col-sm-7">
        											<input type="text" name="annee_promo" class="form-control">
        										</div>
        									</div>

        									<div class="form-group">
        										<div class="col-sm-offset-4 col-sm-8">
        											<button type="submit" class="btn btn-primary waves-effect waves-light">Créer la promotion</button>
        										</div>
        									</div>
        								</form>	
        							</div>	
