                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li class="active"><a href="create_ue.php">Ajouter un UE</a></li>
		...
		<div class="content">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<div class="card-box">
							<h4 class="header-title m-t-0 m-b-30">Ajout d'un UE</h4>
							<div class="row">
								<div class="col-xs-12">
									<form action="../../controleurs/creation_ue.php" class="form-horizontal" role="form" method="POST">
										<div class="form-group">
											<label for="nom_ue" class="col-sm-4 control-label">Nom de l'UE</label>
											<div class="col-sm-7">
										...
										<div class="form-group">
											<label for="coefficient" class="col-sm-4 control-label">Coefficient de l'UE</label>
											<div class="col-sm-7">
										...
										<div class="form-group">
    										<div class="col-sm-offset-4 col-sm-8">
    											<button type="submit" class="btn btn-primary waves-effect waves-light">Créer l'UE</button>
    										</div>
        								</div>
									</form>
								</div>
