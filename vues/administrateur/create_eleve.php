                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li class="active"><a href="create_eleve.php">Ajouter un élève</a></li>
        	...
        	<div class="content">
        		<div class="container">
        			<div class="row">
        				<div class="col-xs-12">
        					<div class="card-box">
        						<h4 class="header-title m-t-0 m-b-30">Ajout d'un élève</h4>
        						<div class="row">
        							<div class="col-xs-12">
        								<form class="form-horizontal" role="form" action="../../controleurs/creation_eleve.php" method="POST">
        									...
        									<div class="form-group">
        										...
        										<div class="col-sm-7">
        											<input type="text" name="num_rue" class="form-control">
        										</div>
        									</div>
        									...
        									<div class="form-group">
        										...
        										<div class="col-sm-7">
        											<input type="text" name="nom_rue" class="form-control">
        										</div>
        									</div>
        									<div class="form-group">
        									...
        									<div class="form-group">
        										...
        										<div class="col-sm-7">
        											<input type="text" name="tel_domicile" class="form-control">
        										</div>
        									</div>
        									...
        									<div class="form-group">
        										...
        										<div class="col-sm-7">
        											<input type="text" name="prenom_medecin" class="form-control">
        										</div>
        									</div>
        									...
        									<div class="form-group">
        										...
        										<div class="col-sm-7">
        											<input type="text" name="tel_medecin" class="form-control">
        										</div>
        									</div>
        									...
        									<div class="form-group">
        										...
        										<div class="col-sm-7">
        											<input type="text" name="allergie" class="form-control" value="">
        										</div>
        									</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="vaccinations" value="">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="remarques_medicales" class="col-sm-4 control-label">Remarque(s) médicale(s)</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" name="remarques_medicales" value="">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="nom_promo" class="col-sm-4 control-label">Promotion</label>
                                                <div class="col-sm-7">
                                                    <select class="form-control select2" name="nom_promo">
                                                
                                                    <?php 
                                                    $bd = new bd();
                                                    $co = $bd->connexion();

                                                    $resultat = mysqli_query($co, "SELECT * FROM Promo");
        									...
        									<div class="form-group">
        										<div class="col-sm-offset-4 col-sm-8">
        											<button type="submit" class="btn btn-primary waves-effect waves-light">Créer l'élève</button>
        										</div>
        									</div>
        								</form>	
        							</div>	
