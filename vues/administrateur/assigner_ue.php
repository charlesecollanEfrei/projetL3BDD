                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="assigner_ue.php">Assigner un UE à une promotion</a></li>
        			...
        			<div class="row">
        				<div class="col-xs-12">
        					<div class="card-box">
        						...
        						<div class="row">
        							<div class="col-xs-12">
        								<form class="form-horizontal" role="form" method="POST" action="../../controleurs/assignation_ue.php">
        									<div class="form-group">
        										<label class="col-sm-4 control-label" for="nom_promo">Promotion</label>
        										<div class="col-sm-7">
													<select name="nom_promo" id="nom_promo" class="form-control select2">
														<?php 
														$bd = new bd();
														$co = $bd->connexion();
        									...
        									<div class="form-group">
        										<div class="col-sm-offset-4 col-sm-8">
        											<button type="submit" class="btn btn-primary waves-effect waves-light">Assigner l'UE</button>
        										</div>
        									</div>
        								</form>	
        							</div>	
