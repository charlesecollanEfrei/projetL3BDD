            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                        	<a href="releve_notes.php" class="waves-effect active"><i class="zmdi zmdi-assignment"></i> <span> Votre relevé de notes </span> </a>
                        </li>
			...
			<div class="content">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<div class="card-box">
                            <h4 class="header-title m-t-0 m-b-30">Votre relevé de notes</h4>
								<div class="row">
                                    <div class="col-xs-12">
                                         <?php $bd = new bd();
                                        $co = $bd->connexion();
                                        $id = $_SESSION['membre']->getMatricule();
                                        $resultat = mysqli_query($co, "SELECT p.nom_epreuves AS pnomep, coeff_epreuve, nom_matiere, note FROM passe p, epreuve e WHERE matricule = $id AND p.nom_epreuves = e.nom_epreuves");
                                        if(mysqli_num_rows($resultat) > 0) {
                                            ...
                                            echo "<p class='text-muted font-13 m-b-25'>Pas de note</p>";
                                        }
                                        ?>
                                    </div>                        
                                </div>
